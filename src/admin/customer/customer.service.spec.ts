...
describe('CustomerService', () => {
  ...
  describe('Create Customer', () => {
    ...
    it('Should call one time method input data in service costomer', () => {
    ...
    // DB Service
    it('Should not call method create customer in db service costomer', () => {
      spyOn(DBService, 'createByModel').and.callThrough();
      expect(DBService.createByModel).not.toHaveBeenCalled();
    })

    it('Should call method create customer in db service costomer', () => {
      spyOn(DBService, 'createByModel').and.callThrough();
      DBService.createByModel([null, null, null, null]);
      expect(DBService.createByModel).toHaveBeenCalled();
    })

    it('Should call one time method create customer in db service costomer', () => {
      spyOn(DBService, 'createByModel').and.callThrough();
      DBService.createByModel([null, null, null, null]);
  ...
  describe('Get Customer', () => {
    ...
    // DB Service
    it('Should not call method get customer in db service costomer', () => {
  ...
  describe('Update Customer', () => {
    ...
    // DB Service
    it('Should not call method update customer in db service costomer', () => {
      spyOn(DBService, 'updateByModel').and.callThrough();
      expect(DBService.updateByModel).not.toHaveBeenCalled();
    })

    it('Should call method update customer in db service costomer', () => {
      spyOn(DBService, 'updateByModel').and.callThrough();
      DBService.updateByModel([null, null, null, null]);
      expect(DBService.updateByModel).toHaveBeenCalled();
    })

    it('Should call one time method update customer in db service costomer', () => {
      spyOn(DBService, 'updateByModel').and.callThrough();
      DBService.updateByModel([null, null, null, null]);
